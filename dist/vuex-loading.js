(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vuexLoading", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["vuexLoading"] = factory(require("vue"));
	else
		root["vuexLoading"] = factory(root["Vue"]);
...
module.exports = function (_ref) {
  var state = _ref.state,
      _actions = _ref._actions;

  var $loading = {};

  var _loop = function _loop(key) {
    $loading[key] = false;
    var action = _actions[key][0];

    _actions[key][0] = function () {
  ...
  _vue2.default.set(state, '$loading', $loading);
};
...
//# sourceMappingURL=vuex-loading.js.map